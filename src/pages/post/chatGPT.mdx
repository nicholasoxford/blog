---
title: create OpeanAI embeddings with typescript
date: 2023-02-03
...
[Github repo](https://github.com/nicholasoxford/lyricgpt)
...
This closely follows their tutorial on `Storing OpenAI embeddings in Postgres with pgvector`. (Source)[https://supabase.com/blog/openai-embeddings-postgres-vector]
