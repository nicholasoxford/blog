...
The long term answer to these problems are ***fully*** decentralized social graphs. To be fully decentralized the graph data must not ephermal, exist on a popular layer 1 [^   2]. These social graphs should be easily accesible, composable, and they should
...
[^2]: I believe in the big three: Bitcoin, Ethereum, Solana